...
$query = mysqli_query($koneksi,"SELECT * FROM agenda inner join users on users.Username=agenda.Username WHERE Username = '$Username'");
?>
    ...
    <section id="ubah" class="ubah bg-light">
      <div class="container pb-4">
		...
		<a href="data_agenda.php"> LIHAT DATA AGENDA</a>
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
            ...
            <input type="text" name="agenda" class="form-control" id="exampleInputPassword1">
          </div>
		  <div class="form-group">
...
$Username = $_SESSION['Username'];
$sql= "INSERT INTO agenda (Id_agenda, Username, Tempat, Nama_agenda, Dari, Tanggal) VALUES ('', '$Username', '$tempat','$agenda','$dari','$tanggal')";
