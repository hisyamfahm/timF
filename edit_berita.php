...
?>
    ...
    <section id="ubah" class="ubah bg-light">
      <div class="container pb-4">
		...
		<a href="data_berita.php">LIHAT SEMUA DATA BERITA</a>
		<form class="login100-form validate-form" method="post" action="" enctype = "multipart/form-data">
	    <div class="form-group">
        <label for="exampleInputPassword1">Id</label>
        <input type="text" name="judul" class="form-control" id="exampleInputPassword1" readonly value="<?php echo $row_query['Id_berita']; ?>">
        </div>
		<div class="form-group">
...
$sql="UPDATE berita SET Judul='$judul', Dokumen='$namee', Isi='$text', Tanggal='$tanggal',Foto='$name' WHERE Id_berita = '$id'";
