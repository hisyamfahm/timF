...
if(isset($_POST['login'])){
	...
	$login = mysqli_query($koneksi,"select Username, Email, Password, Role, Status FROM users where (Username='$user' or email='$user') and Password='$pass' ");
	...
	if ( mysqli_num_rows($login) > 0 ){
		...
		header("location:login.php?pesan=".base64_encode("Username dan Password tidak sesuai !"));
	}
}
?>